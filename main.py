...
class LudoGame:
    ...
    def move_token_p(self, player_object, steps):
    ...
    def move_token_q(self, player_object, steps):
    ...
    def play_game(self):
        ...
        counter = 0
        while True:
            # display round number and the current position of all player tokens
            counter += 1
            print("round #" + str(counter))
            print(self.get_all_player_spaces())
            if counter == 100:
                print("Tie Game! All players rolled 100 times.")
                break
...
# create game object to execute play game method
game = LudoGame()
game.play_game()
